...
<div class="row">
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
            <h5 class="card-title">List Transaction (Dataset)</h5>
                <table class="table table-striped mb-0">
                    <thead>
                    </thead>
                    <tbody>
                        @foreach($transaction as $pattern => $reg)
                        @php $no = 1; @endphp
                            <tr>
                                <th>{{ $reg['product_name1'] }}</th>
                            </tr>
                            <tr>
                              <th>{{ $reg['product_name2'] }}</th>
                          </tr>
                            <tr>
                              <th>{{ $reg['product_name3'] }}</th>
                          </tr>
                            <tr>
                              <th>{{ $reg['product_name4'] }}</th>
                          </tr>
                        @endforeach
                    </tbody>
                </table>
