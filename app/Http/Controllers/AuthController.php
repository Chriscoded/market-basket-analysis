...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        $rules = [
            ...
            $messages = [
                'password.required'     => 'Password requird',
                'password.confirmed'    => 'Confirm password must match with password'
            ];
            ...
            if($simpan){
                ...
                Session::flash('errors', ['' => 'Registeration errror, please try again']);
